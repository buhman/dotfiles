...
modMeh = shiftMask .|. mod1Mask .|. controlMask
modHyper = mod4Mask .|.  shiftMask .|. mod1Mask .|. controlMask
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_p     ), spawn "dmenu_run -fn DejavuSansMono-11")

    -- password manager
    , ((modm .|. shiftMask, xK_p     ), spawn "keepmenu")
    ...
    , ((modm              , xK_Prior ), spawn "pactl set-sink-volume 0 +5%")
    , ((modm .|. shiftMask, xK_Prior ), spawn "pactl set-sink-volume 0 +2.5%")

    , ((0                 , xF86XK_AudioLowerVolume ), spawn "pactl set-sink-volume 0 -5%")
    , ((modm              , xK_Next ), spawn "pactl set-sink-volume 0 -5%")
    , ((modm .|. shiftMask, xK_Next ), spawn "pactl set-sink-volume 0 -2.5%")

    -- brightness
    , ((modm .|. shiftMask, xK_Left      ), spawn "sudo brightnessctl set 5%-")
    , ((modm .|. shiftMask, xK_Right     ), spawn "sudo brightnessctl set +5%")

    -- redshift
    , ((modm .|. shiftMask, xK_Up       ), spawn "redshift -x")
    , ((modm .|. shiftMask, xK_Down     ), spawn "redshift -b 0.80:0.80 -O 2000")

    -- lock
    , ((modm .|. shiftMask, xK_z     ), spawn "slock")

    -- tools
    , ((modm .|. shiftMask, xK_backslash ), spawn "emacsclient -c")
    , ((modm .|. shiftMask, xK_bracketright ), spawn "pavucontrol")
    , ((modm .|. shiftMask, xK_bracketleft ), spawn "networkmanager_dmenu -fn DejavuSansMono-11")
    ...
    --
    [ ((modMeh,               xK_a     ), sendMessage Shrink )
    , ((modMeh,               xK_t     ), sendMessage Expand )

    --
    , ((modMeh,               xK_p     ), sendMessage (IncMasterN (-1)) )
    , ((modMeh,               xK_q     ), sendMessage (IncMasterN 1) )
...
--    where
--        xmobar = "xmobar ~/.xmonad/xmobar.hs"
--        pp = xmobarPP
